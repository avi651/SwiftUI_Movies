...
struct CastView: View {
    ...
    let creditId: String
    @StateObject private var castViewModel: CastDetailViewModel = Container.shared.castDetailViewModel()
    ...
    var body: some View {
        ZStack {
            ...
            await castViewModel.fetchCastDetails(castDetail: creditId)
        }
    }
}
